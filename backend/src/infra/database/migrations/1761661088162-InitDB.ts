...
export class InitDB1761661088162 implements MigrationInterface {
  name = 'InitDB1761661088162';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_93e3e4a8c94246915b524d12bc" ON "user" ("legalName") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_93e3e4a8c94246915b524d12bc"`,
    );
    await queryRunner.query(
